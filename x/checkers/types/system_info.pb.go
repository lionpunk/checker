...
func (m *SystemInfo) GetBeforeIndex() string {
	if m != nil {
...
func (m *SystemInfo) GetAfterIndex() string {
	if m != nil {
		return m.AfterIndex
	}
	return ""
...
var fileDescriptor_1580c0dd88c0be2b = []byte{
	...
	0x80, 0x33, 0x94, 0x36, 0x31, 0x72, 0x71, 0x05, 0x83, 0x95, 0x7b, 0xe6, 0xa5, 0xe5, 0x0b, 0x89,
	0x71, 0xb1, 0xe5, 0xa5, 0x56, 0x94, 0x78, 0xa6, 0x48, 0x30, 0x2a, 0x30, 0x6a, 0xb0, 0x04, 0x41,
	0x79, 0x42, 0x2a, 0x5c, 0xbc, 0x69, 0x99, 0x69, 0xf9, 0x1e, 0xa9, 0x89, 0x29, 0x9e, 0x79, 0x29,
	0xa9, 0x15, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0xa8, 0x82, 0x30, 0x55, 0x21, 0x89, 0x99,
	0x39, 0x10, 0x55, 0xcc, 0x08, 0x55, 0x70, 0x41, 0x21, 0x05, 0x2e, 0xee, 0xa4, 0xd4, 0xb4, 0xfc,
	0xa2, 0x54, 0x88, 0x1a, 0x76, 0xb0, 0x1a, 0x64, 0x21, 0x21, 0x39, 0x2e, 0xae, 0xc4, 0xb4, 0x92,
	0xd4, 0x22, 0x88, 0x02, 0x0e, 0xb0, 0x02, 0x24, 0x11, 0x27, 0x97, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	...
	0xd5, 0x07, 0x7b, 0x59, 0x1f, 0x1e, 0x28, 0x15, 0x08, 0x66, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12,
	0x1b, 0x38, 0x68, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x8e, 0xbf, 0xa3, 0x16, 0x38, 0x01,
	0x00, 0x00,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AfterIndex) > 0 {
		...
		i = encodeVarintSystemInfo(dAtA, i, uint64(len(m.AfterIndex)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.BeforeIndex) > 0 {
		...
		i = encodeVarintSystemInfo(dAtA, i, uint64(len(m.BeforeIndex)))
		i--
		dAtA[i] = 0x3a
	}
